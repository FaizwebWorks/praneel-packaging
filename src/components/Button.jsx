...
export function PrimaryButton({ children, icon: Icon, className = "", href, onClick, ...props }) {
    ...
    const baseClassName = `group relative inline-flex cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full bg-white px-6 py-3 text-sm font-semibold text-zinc-900 hover:text-white border border-transparent hover:border-zinc-500 transition-all duration-300 ${className}`;
...
export function SecondaryButton({ children, icon: Icon, className = "", href, onClick, ...props }) {
    ...
    const baseClassName = `group relative inline-flex cursor-pointer items-center justify-center gap-2 overflow-hidden rounded-full border border-zinc-700 bg-zinc-800/50 px-6 py-3 text-sm font-semibold text-zinc-100 hover:text-zinc-900 transition-all duration-300 ${className}`;
