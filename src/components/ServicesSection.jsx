        ...
        <section id="services" className="relative z-10 w-full overflow-hidden py-24 sm:py-32">
            ...
            <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
                    <div className="max-w-2xl">
                        ...
                        <AnimatedText
                            ...
                            className="heading-font text-4xl font-semibold leading-tight text-[#1E56A0] sm:text-5xl"
                        />
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        <button
                            ...
                            className="p-3 group rounded-full border border-[#1E56A0]/30 bg-[#1E56A0]/5 text-[#1E56A0] hover:bg-[#1E56A0] hover:text-white transition-all duration-300"
                        >
                            <ChevronLeft className="h-6 w-6 group-hover:scale-[1.2] transition-all duration-300 ease-in" />
                        </button>
                        <button
                            onClick={() => scrollTo(Math.min(services.length - 1, scrollIndex + 1))}
                            className="p-3 group rounded-full border border-[#1E56A0]/30 bg-[#1E56A0]/5 text-[#1E56A0] hover:bg-[#1E56A0] hover:text-white transition-all duration-300"
                        >
                            <ChevronRight className="h-6 w-6 group-hover:scale-[1.2] transition-all duration-300 ease-in" />
                        </button>
                    </div>
                </div>
                ...
                <div className="mt-12 flex justify-center items-center gap-3">
                    {services.map((_, i) => (
                        <button
                            key={i}
                            onClick={() => scrollTo(i)}
                            className={`h-1.5 transition-all duration-300 rounded-full ${scrollIndex === i ? "w-8 bg-[#1E56A0]" : "w-2 bg-[#1E56A0]/20 hover:bg-[#1E56A0]"
                                }`}
                        />
                    ))}
                </div>
                ...
                <div className="mt-20 text-center">
                    <PrimaryButton icon={ArrowRight} href="https://wa.me/919023827460?text=Hi,%20I%20want%20to%20build%20a%20custom%20packaging%20design" className="px-12 py-5 text-lg rounded-2xl">
